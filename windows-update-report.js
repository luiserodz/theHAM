...
async function loadLogo() {
    ...
    async function addCompactChartToPDF(pdf, chartId, title, x, y, width, height) {
        ...
        function addDetailedTable(pdf) {
            ...
            pdf.autoTable({
                head: [['Update Name', 'Version', 'Severity', 'Date', 'Pending Updates', 'Deployed']], body: tableData,
                startY: 32,
                theme: 'striped',
                headStyles: {
                    fillColor: [0, 120, 212],
                ...
                margin: { top: 22, left: 15, right: 15 },
                showHead: 'everyPage',
                ...
                didDrawPage: function(data) {
                    ...
                    if (data.pageNumber > 1) {
                        ...
                        pdf.setFontSize(9); // Use a smaller font size for continuation page numbers
                        pdf.setFont(undefined, 'normal');
                        pdf.setTextColor(108, 117, 125);
            ...
            if (finalY < pdf.internal.pageSize.getHeight() - 40) {
                ...
                pdf.setFontSize(8); // Use a smaller font size for summary text
